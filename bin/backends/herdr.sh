...
# any error. Mirrors tmux's pane_current_path read, which fm-spawn.sh uses to
# confirm that a pane arrived in its leased worktree.
#
...
# shell `cd`s or enters a subshell. Reading it here would report the original
